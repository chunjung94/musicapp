...
//        self.addViewsWithCode()
    ...
    func updateTimeLabelText(time: TimeInterval) {
        ...
        let timeText: String = String(format: "%021d:%02ld:%02ld", minute, second, milisecond)
    ...
    func addProgressSlider() {
        ...
        slider.addTarget(self, action: #selector(self.sliderValueChaged(_:)), for: UIControl.Event.valueChanged)
